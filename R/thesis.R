...
#' to specify using the Queen's University Thesis LaTeX template and cls files.
#'
#' @export
#'
...
#'
#' @return A modified \code{pdf_document} based on the Queen's University Thesis LaTeX
#'   template
#' @examples
#' \dontrun{
